...
gulp production &&
cordova build --release android &&
jarsigner -verbose -sigalg SHA1withRSA -digestalg SHA1 -keystore /Users/dmitri/.android/google-play-app-signing.jks platforms/android/build/outputs/apk/android-x86-release-unsigned.apk GooglePlayAppSigningKey &&
/Applications/adt-bundle-mac-x86_64-20140702/sdk/build-tools/25.0.0/zipalign -v 4 platforms/android/build/outputs/apk/android-x86-release-unsigned.apk DengueChat-x86.apk
