angular.module("starter.controllers").controller("postsCtrl", [
  ...
  function($scope, Post, $ionicModal, $ionicLoading, User) {
    ...
    $scope.$on("$ionicView.loaded", function() {
      $ionicLoading.show({
        template: "<ion-spinner></ion-spinner><br>Cargando los posts...",
    ...
    $scope.refresh = function(offset) {
      $ionicLoading.show({
        template:
          "<ion-spinner></ion-spinner><br>Cargando los posts de denguechat.com...",
        hideOnStateChange: true
      });
    ...
    $scope.createPost = function() {
      $ionicLoading.show({
        template: "<ion-spinner></ion-spinner><br>Creando post...",
        hideOnStateChange: true
      });
